package com.yqyan.springboot.demo.validation;
...
public class User implements Serializable {
    ...
    @Digits(integer = 2, fraction = 2, message = "折扣值最多支持2位整数，2位小数")
    @DoubleMin(value = 0.1, message = "折扣值必须大于0.1")
    @DoubleMax(value = 10.0, message = "折扣值最大值为10.0")
